      ...
      <Container>
        <Row className="justify-content-center">
          <Col>
            ...
            <h4>How to play</h4>
            <p>
              Tap left or right to move the white dwarf star and collect as many
              planets as you can. Hurry and be careful with black holes,
              otherwise you will become a supernova.
            </p>
            ...
            <ul>
              ...
              <li>1 scene</li>
              <li>3 infinite scrolling backgrounds with nebulas / starfield</li>
              ...
              <li>
                Rate button: Opens the market page for the players to rate your
                app.
              </li>
            </ul>
